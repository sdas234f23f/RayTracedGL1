...
#define FB_IMAGE_INDEX_BLOOM_RESULT 68
#define FB_IMAGE_INDEX_WIPE_EFFECT_SOURCE 69
#define FB_IMAGE_INDEX_RESERVOIRS 70
#define FB_IMAGE_INDEX_RESERVOIRS_PREV 71
#define FB_IMAGE_INDEX_RESERVOIRS_INITIAL 72
...
layout(set = DESC_SET_FRAMEBUFFERS, binding = 68, r11f_g11f_b10f) uniform image2D framebufBloom_Result;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 69, r11f_g11f_b10f) uniform image2D framebufWipeEffectSource;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 70, rgba32ui) uniform uimage2D framebufReservoirs;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 71, rgba32ui) uniform uimage2D framebufReservoirs_Prev;
layout(set = DESC_SET_FRAMEBUFFERS, binding = 72, rgba32ui) uniform uimage2D framebufReservoirsInitial;
