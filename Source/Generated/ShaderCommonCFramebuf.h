...
enum FramebufferImageIndex
{
    ...
    FB_IMAGE_INDEX_BLOOM_RESULT = 68,
    FB_IMAGE_INDEX_WIPE_EFFECT_SOURCE = 69,
    FB_IMAGE_INDEX_RESERVOIRS = 70,
    FB_IMAGE_INDEX_RESERVOIRS_PREV = 71,
    FB_IMAGE_INDEX_RESERVOIRS_INITIAL = 72,
    ...
    FB_IMAGE_INDEX_Q2_COLOR_L_F_S_H = 79,
    FB_IMAGE_INDEX_Q2_COLOR_L_F_C_O_C_G = 80,
    FB_IMAGE_INDEX_Q2_COLOR_H_F = 81,
    FB_IMAGE_INDEX_Q2_COLOR_SPEC = 82,
    FB_IMAGE_INDEX_Q2_HIST_COLOR_L_F_S_H = 83,
    FB_IMAGE_INDEX_Q2_HIST_COLOR_L_F_S_H_PREV = 84,
    FB_IMAGE_INDEX_Q2_HIST_COLOR_L_F_C_O_C_G = 85,
    FB_IMAGE_INDEX_Q2_HIST_COLOR_L_F_C_O_C_G_PREV = 86,
    FB_IMAGE_INDEX_Q2_HIST_COLOR_H_F = 87,
    FB_IMAGE_INDEX_Q2_HIST_COLOR_H_F_PREV = 88,
    FB_IMAGE_INDEX_Q2_HIST_MOMENTS_H_F = 89,
    FB_IMAGE_INDEX_Q2_HIST_MOMENTS_H_F_PREV = 90,
    FB_IMAGE_INDEX_Q2_FILTERED_SPEC = 91,
    FB_IMAGE_INDEX_Q2_FILTERED_SPEC_PREV = 92,
    FB_IMAGE_INDEX_Q2_ATROUS_PING_L_F_S_H = 93,
    FB_IMAGE_INDEX_Q2_ATROUS_PONG_L_F_S_H = 94,
    FB_IMAGE_INDEX_Q2_ATROUS_PING_L_F_C_O_C_G = 95,
    FB_IMAGE_INDEX_Q2_ATROUS_PONG_L_F_C_O_C_G = 96,
    FB_IMAGE_INDEX_Q2_ATROUS_PING_H_F = 97,
    FB_IMAGE_INDEX_Q2_ATROUS_PONG_H_F = 98,
    FB_IMAGE_INDEX_Q2_ATROUS_PING_SPEC = 99,
    FB_IMAGE_INDEX_Q2_ATROUS_PONG_SPEC = 100,
    FB_IMAGE_INDEX_Q2_ATROUS_PING_MOMENTS = 101,
    FB_IMAGE_INDEX_Q2_ATROUS_PONG_MOMENTS = 102,
    FB_IMAGE_INDEX_Q2_GRAD_L_F_PING = 103,
    FB_IMAGE_INDEX_Q2_GRAD_L_F_PONG = 104,
    FB_IMAGE_INDEX_Q2_GRAD_H_F_SPEC_PING = 105,
    FB_IMAGE_INDEX_Q2_GRAD_H_F_SPEC_PONG = 106,
    FB_IMAGE_INDEX_Q2_GRAD_SMPL_POS = 107,
    FB_IMAGE_INDEX_Q2_GRAD_SMPL_POS_PREV = 108,
    FB_IMAGE_INDEX_Q2_COLOR = 109,
    FB_IMAGE_INDEX_Q2_TAA_OUTPUT = 110,
    FB_IMAGE_INDEX_Q2_TAA_HISTORY = 111,
    FB_IMAGE_INDEX_Q2_TAA_HISTORY_PREV = 112,
    FB_IMAGE_INDEX_Q2_RNG_SEED = 113,
    FB_IMAGE_INDEX_Q2_RNG_SEED_PREV = 114,
};
